...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.zona.title_singular') }}
    </div>

    <div class="card-body">
<<<<<<< HEAD
        <form method="POST" action="{{ route('admin.zonas.update', [$zona->id]) }}" enctype="multipart/form-data">
=======
        <form method="POST" action="{{ route("admin.zonas.update", [$zona->id]) }}" enctype="multipart/form-data">
...
<<<<<<< HEAD
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre"
                    id="nombre" value="{{ old('nombre', $zona->nombre) }}" required>
                @if($errors->has('nombre'))
                <div class="invalid-feedback">
                    {{ $errors->first('nombre') }}
                </div>
=======
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $zona->nombre) }}" required>
                @if($errors->has('nombre'))
...
<<<<<<< HEAD
                <input class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" type="text"
                    name="descripcion" id="descripcion" value="{{ old('descripcion', $zona->descripcion) }}">
                @if($errors->has('descripcion'))
                <div class="invalid-feedback">
                    {{ $errors->first('descripcion') }}
                </div>
=======
                <input class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" type="text" name="descripcion" id="descripcion" value="{{ old('descripcion', $zona->descripcion) }}">
                @if($errors->has('descripcion'))
...
<<<<<<< HEAD
                <select class="form-control {{ $errors->has('entidad') ? 'is-invalid' : '' }}" name="entidad"
                    ...
                    <option value="{{ $key }}" {{ old('entidad', $zona->entidad) === (string) $key ? 'selected' : ''
                        }}>{{ $label }}</option>
                    @endforeach
                </select>
...
=======
                <select class="form-control {{ $errors->has('entidad') ? 'is-invalid' : '' }}" name="entidad" id="entidad">
                    ...
                    @foreach(App\Models\Zona::ENTIDAD_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('entidad', $zona->entidad) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('entidad'))
...
<<<<<<< HEAD
                <div class="form-check {{ $errors->has('estatus') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="radio" id="estatus_{{ $key }}" name="estatus"
                        value="{{ $key }}" {{ old('estatus', $zona->estatus) === (string) $key ? 'checked' : '' }}
                    required>
...
=======
                    <div class="form-check {{ $errors->has('estatus') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="estatus_{{ $key }}" name="estatus" value="{{ $key }}" {{ old('estatus', $zona->estatus) === (string) $key ? 'checked' : '' }} required>
                        <label class="form-check-label" for="estatus_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('estatus'))
