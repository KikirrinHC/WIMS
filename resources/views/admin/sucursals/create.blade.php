        ...
        <form method="POST" action="{{ route('admin.sucursals.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('agencia') ? 'is-invalid' : '' }}" name="agencia_id"
                    ...
                    <option value="{{ $id }}" {{ old('agencia_id')==$id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('zona') ? 'is-invalid' : '' }}" name="zona_id"
                    ...
                    <option value="{{ $id }}" {{ old('zona_id')==$id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('zona'))
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('municipio') ? 'is-invalid' : '' }}" type="text"
                    name="municipio" id="municipio" value="{{ old('municipio', '') }}">
