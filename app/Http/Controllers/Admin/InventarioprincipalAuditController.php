...
use App\Http\Requests\StoreInventarioprincipalAuditRequest;
use App\Models\InventarioprincipalAudit;
use Gate;
use Illuminate\Http\Request;
use Symfony\Component\HttpFoundation\Response;

class InventarioprincipalAuditController extends Controller
{
    /*
...
*/
    public function store(StoreInventarioprincipalAuditRequest $request)
    {
        $inventarioprincipalaudit = InventarioprincipalAudit::create($request->all());

        return redirect()->route('admin.inventarioprincipals_audit.index');
    }
    /*
