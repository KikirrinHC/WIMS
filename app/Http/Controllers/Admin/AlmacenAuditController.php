...
use App\Http\Requests\StoreAlmacenAuditRequest;
use App\Models\AlmacenAudit;
use Gate;
use Illuminate\Http\Request;
use Symfony\Component\HttpFoundation\Response;

class AlmacenAuditController extends Controller
{
    /*
...
*/
    public function store(StoreAlmacenAuditRequest $request)
    {
        $almacenAudit = AlmacenAudit::create($request->all());

        return redirect()->route('admin.almacenes_audit.index');
    }
    /*
